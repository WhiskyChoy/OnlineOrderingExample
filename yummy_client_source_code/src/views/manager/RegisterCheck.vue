...
<script>
    import {approveRestaurant} from "../../ajax/managerAjax";
    import {disapproveRestaurant, getRestaurantWaitRegister} from "../../ajax/managerAjax";

    export default {
        name: "RegisterCheck",
        methods: {
            handlePass(scope) {
                approveRestaurant({restaurantId: scope.row.id}).then(response => {
            ...
            handleReject(scope) {
                disapproveRestaurant({restaurantId: scope.row.id}).then(response => {
                    if (response.data['successful']) {
                        this.$message({
        ...
        mounted() {
            getRestaurantWaitRegister().then(response => {
